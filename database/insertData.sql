...
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","How many digits are there in Hindu-Arabic System?","10","20","30","40","1","8081");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","What does 1 googol means?","1 followed by hundred zeros","1 followed by thousand zeros","1 followed by ten thousand zeros","1 followed by 1 lakh zeros","1","8082");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","Among the following which natural number has no predecessor?","100","200","1","0","3","8082");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","Among the following which whole number has no predecessor?","-1","0","1","e","2","8083");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","An integer that is divisible by 2 is called:","Even number","Natural number","Odd number","Whole number","1","8084");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","In which number system, there is no symbol for zero?","Hindu Arabic system","Roman","Egyptian","Mesopotamia","2","8085");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","In Roman numerals M represents 1000, what does M represent?","10,000","50,000","10,000,000","500","3","8086");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1001","What does D represent in Roman numeral system?","100","500","1000","50","2","8086");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Google (www.google.com) is a:","Search Engine","Number in Math","Directory of images","Chat service on the web","1","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Which is not an Internet protocol?","HTTP","FTP","STP","IP","3","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Which of the following is not a valid domain name?","www.yahoo.com","www.yahoo.co.uk","www.com.yahoo","www.yahoo.co.in","3","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","AOL stands for:","Arranged Outer Line","America Over LAN"," Audio Over LAN","America On-line","4","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Another name for a computer chip is:","Execute","Micro chip","Microprocessor","Select","2","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Where is the headquarters of Intel located?","Redmond, Washington","Tucson, Arizona","Santa Clara, California","Richmond, Virginia","3","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","What does EPROM stand for?","Electric Programmable Read Only Memory","Erasable Programmable Read Only Memory","Evaluable Philotic Random Optic Memory","Every Person Requires One Mind","2","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","In computer jargon, RAM refers to","Read Only Menu","Random Access Memory","Random Accent Memory","Read Access Memory","2","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","Which of the following is not a computer language?"," Windows 98","PASCAL","FORTRAN","C","1","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1002","What's a web browser?","A kind of spider","A computer that stores WWW files","A person who likes to look at websites"," A software program that allows you to access sites on the World Wide Web","4","8087");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","How many bits is a byte?","4","8","16","32","2","8089");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","How do you subscribe to an Internet mailing list?","Contact your Internet service provider","Send e-mail to the list manager","Telephone the mailing list webmaster","Send a letter to the list","2","8089");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","Computers calculate numbers in what mode?","Decimal","Octal","Binary","None of the above","3","8089");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","The speed of your net access is defined in terms of:","RAM","MHz","Kbps","Megabytes","3","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","Which of these is a search engine?","FTP","Google","Archie","ARPANET","2","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","What does CPU stand for?","Cute People United","Commonwealth Press Union","Computer Parts of USA","Central Processing Unit","4","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","Which of these is a valid e-mail address?","support.at.objectivebooks","www.objectivebooks.com","support@objectivebooks.com","support@objectivebooks","3","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","Modem stands for:","Modulator Demodulator","Monetary Devaluation Exchange Mechanism","Memory Demagnetization","Monetary Demarcation","1","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","What is the difference between the Internet and an intranet?","One is public, the other is private","One is safer than the other","One can be monitored, the other can't","None of the above","1","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1003","Your computer has gradually slowed down. What's the most likely cause?","Overheating","Your processor chip is just getting old","Adware/spyware is infecting your PC","You dropped a sandwich in your computer","3","8088");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","A JPG is:","A Jumper Programmed Graphic","A format for an image file","A type of hard disk","A unit of measure for memory","2","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","A dual-layer DVD is valued because it:","Can hold more data","Contains a backup of the data stored","Uses a second layer to offer a speed increase","Creates alternative sound tracks","1","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","Another word for 'Graphics for a word processor'?","Peripheral","Clip art","Highlight","Execute","2","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","What Designates where the next action occurs?","Decode","Highlight","Select","Mother board","3","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","Which was an early mainframe computer?","ENIAC","UNIC","BRAINIA","FUNTRIA","1","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","RAM stands for:","Random Access Memory","Really Annoying Machine","Read A Manual","Real Absolute Memory","1","8090");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","How can you catch a computer virus?","Sending e-mail messages","Using a laptop during the winter","Opening e-mail attachments","Shopping on-line","3","8091");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","Which of these is not a computer?","Aptiva","Macintosh","Acorn","Paseo","4","8091");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","The home page of a web site is:","The largest page","The last page","The first page","The most colorful page","3","8091");
insert into questions(ID_sub,content,opt1,opt2,opt3,opt4,correct,created_by) values ("1004","HTML is used to:","Plot complicated graphs","Author Web Pages","Translate one language into another","Solve equations","2","8091");
